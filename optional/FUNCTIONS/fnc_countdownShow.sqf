...
DESCRIPTION:
Announce to the player how much time there's left in the mission. You are free 
to disable as many of these as you want in order to keep the players from 
knowing how much time they have left. It's also sort of annoying to be reminded 
every 15 minutes.
