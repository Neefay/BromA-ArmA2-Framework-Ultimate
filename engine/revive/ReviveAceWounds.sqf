...
call compile preprocessFileLineNumbers 'engine\revive\Configuracion.sqf';
call compile preprocessFileLineNumbers 'engine\revive\Data\language.sqf';
...
Colum_revive_evento_HeridoGrave= compile preprocessFileLineNumbers 'engine\revive\Data\Evento_herido.sqf';
/***********************************************************************************************/
...
Colum_revive_evento_Muerte= compile preprocessFileLineNumbers 'engine\revive\Data\muerte.sqf';
...
if (Colum_revive_TKcheck || Colum_revive_WoundScoring) then { ExecVM "engine\revive\Data\JugadorHit.sqf" }; //Detect TK's
