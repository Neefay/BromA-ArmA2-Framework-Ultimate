...
Colum_Revive_Funcion_Message = {
	...
	{
	  case 1: {hintSilent format["Lives: %1 of %2",Colum_revive_VidasLocal-1,Colum_revive_VidasMax-1];};
	  case 2: {titlecut ["","PLAIN",2]};
	  case 3: {10 cutText ["","PLAIN",1];};
	  case 4: {10 cutText ["","PLAIN",1];};
	  case 5: {10 cutText ["","PLAIN",1];};
	  case 6: {10005 cutText ["","PLAIN",2];};
	  case 7: {10 cutText ["Please, ONLY use respawn button in needed situations","BLACK"];};
	  case 8: {10 cutText ["","PLAIN DOWN"];};
