...
DESCRIPTION:
After an ending is reached, perform checks on what kind of victory it was and
how effective was either team, then calls the ending screen.
...
*/
[] execVM (CUSTOM_FILES_PATH+"ending-screen.sqf");