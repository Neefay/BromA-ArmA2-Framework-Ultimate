...
// =============================================================================
useCasualtyCap = true;                                          // Enable module - true or false.

    casualtyGroupPlayer = [alpha_grp_blu, bravo_grp_blu];       // Casualty groups for the Player group
    
    casualtyGroupEnemy = [alpha_grp_op, bravo_grp_op];          // Casualty group for the Enemy group - Ignore if COOP
// =============================================================================
...
useEEcheck = false;                             // Enable module - true or false.
    ...
    EEGroupName = groupname;                    // Group to be checked.
    EEObjectName = objectname;                  // Object to be checked.
...
useSpawnProtection = false;                      // Enable module - true or false.
    ...
    setupSize = 25;                             // Size of the Setup Zone for TVTs - ignore if COOP        
// =============================================================================
...
//                        ==== OPFOR 1st PLATOON ====
                      ...
                      "Zero69Actual_op","Platoon69Medic_op",
...
//                      ==== INDEPENDENT 1st PLATOON ====
                      ...
                      "Zero69Actual_ind","Platoon69Medic_ind",
